    ...
    module Authentication
      ...
      class Middleware < Roda
        ...
        plugin :rodauth do
          ...
          email_auth_view { view "email", nil }
          ...
          reset_password_request_view { view "password_reset", nil }
          ...
          verify_account_view { view "verify", nil }
          resend_verify_account_view { view "user_verify", nil }
          ...
          verify_login_change_route "verify/login"
          verify_login_change_view { view "login_verify", nil }
        end
